...
const ChildComponent: React.FC<ChildComponentProps> = ({ cars }) => {
    return (
        <div className="mt-48 flex py-5 px-14 gap-5 flex-col md:flex-row md:flex-wrap lg:flex-row lg:flex-nowrap lg:w-full">
            ...
            {cars.map((car, index) => (
                <div key={index} className="car-card text-center hover:scale-105 transform transition duration-300 ease-in-out ">
                    ...
                    <Image
                        src={`/images/car${index + 1}.jpeg`} // Dynamic image path
